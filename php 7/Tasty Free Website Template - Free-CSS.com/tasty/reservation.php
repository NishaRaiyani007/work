            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-push-6 col-sm-6 col-sm-push-6">
                        <form action="" method="POST" id="form-wrap">
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    ...
                                    <select id="many" name="people" class="form-control custom_select">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $HowManyPeople = mysqli_real_escape_string($conn, $_POST['people']);
    ...
    // Insert query
    $query = "INSERT INTO `reservation` (`name`, `people`, `when`) VALUES ('$YourName', '$HowManyPeople', '$When')";
