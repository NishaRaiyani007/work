...
<body>
    ...
    <div class="container-fluid px-0">
        <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <?php
                $customer_sql = mysqli_query($conn, "SELECT * FROM slider");
                $is_first = true; // Variable to track the first slide
                while ($customer_data = mysqli_fetch_array($customer_sql)) {
                    $active_class = $is_first ? 'active' : ''; // Only the first slide should be active
                    $is_first = false;
                    ?>

                    <div class="carousel-item <?php echo $active_class; ?>">
                        <img src="./admin/images/<?php echo $customer_data['image']; ?>" class="img-fluid"
                            alt="First slide">
                        <div class="carousel-caption">
                            <div class="container carousel-content">
                                <h6 class="text-secondary h4 animated fadeInUp">
                                    <?php echo $customer_data['title']; ?>
                                </h6>
                                <h5 class="text-secondary h4 animated fadeInUp">
                                    <?php echo $customer_data['heading']; ?>
                                </h5>
                                <h4 class="text-secondary h4 animated fadeInUp">
                                    <?php echo $customer_data['contect']; ?>
                                </h4>
                                <p class="mb-4 text-white fs-5 animated fadeInDown">
                                    <?php echo $customer_data['description']; ?>
                                </p>
    ...
    <div class="container-fluid bg-secondary py-5">
        <div class="container">
            <?php
            $customer_sql = mysqli_query($conn, "SELECT * FROM counter");
            $customer_data = mysqli_fetch_array($customer_sql);
            ?>
            <div class="row">
                <div class="col-lg-3 wow fadeIn" data-wow-delay=".1s">
                    <div class="d-flex counter">
                        <h1 class="me-3 text-primary counter-value"><?php echo $customer_data['title']; ?></h1>
                        <h5 class="text-white mt-1"> <?php echo $customer_data['description']; ?></h5>
                    </div>
                </div>
    ...
    <div class="container-fluid services py-5 mb-5">
        <div class="container">
            <?php
            $customer_sql = mysqli_query($conn, "SELECT * FROM service");
            $customer_data = mysqli_fetch_array($customer_sql);
            ?>
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                <h5 class="text-primary"><?php echo $customer_data['title']; ?></h5>
                <h1><?php echo $customer_data['heading']; ?></h1>
            </div>
            <div class="row g-5 services-inner">
                <?php
                while ($customer_dat = mysqli_fetch_array($customer_sql)) {
                    ?>
                        ...
                        <div class="services-item bg-light">
                            <div class="p-4 text-center services-content">
                                <div class="services-content-icon">
                                    ...
                                    <img src="./admin/images/<?php echo $customer_dat['img']; ?>" alt="">
                                    <h4 class="mb-3"></h4>
    ...
    <div class="container-fluid project py-5 mb-5">
        <div class="container">
            <?php
            $customer_sql = mysqli_query($conn, "SELECT * FROM project");
            $customer_data = mysqli_fetch_array($customer_sql);
            ?>
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                <h5 class="text-primary"><?php echo $customer_data['title']; ?></h5>
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".3s">
                        <div class="project-item">
                            <div class="project-img">
                                <img src="./admin/images/<?php echo $customer_data['img']; ?>"
    ...
    <div class="container-fluid blog py-5 mb-5">
        <div class="container">
            <?php
            $customer_sql = mysqli_query($conn, "SELECT * FROM blog");
            $customer_data = mysqli_fetch_array($customer_sql);
            ?>
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                <h5 class="text-primary"><?php echo $customer_data['title']; ?></h5>
                ...
                while ($customer_data = mysqli_fetch_array($customer_sql)) {
                    ...
                    <div class="col-lg-6 col-xl-4 wow fadeIn" data-wow-delay=".3s">
                        <div class="blog-item position-relative bg-light rounded">
                            <img src="./admin/images/<?php echo $customer_data['img']; ?>" alt="">
                            ...
                            <div class="blog-content text-center position-relative px-3" style="margin-top: -25px;">
                                ...
                                <span class="text-secondary"><?php echo $customer_data['pro_date']; ?>
                                </span>
                                <p class="py-2"><?php echo $customer_data['description']; ?></p>
                            </div>
                            <div
    ...
    <div class="container-fluid py-5 mb-5 team">
        <div class="container">
            <?php
            $customer_sql = mysqli_query($conn, "SELECT * FROM team");
            $customer_data = mysqli_fetch_array($customer_sql);
            ?>
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                <h5 class="text-primary"> <?php echo $customer_data['title']; ?></h5>
                        ...
                        <div class="team-content">
                            <div class="team-img-icon">
                                <div class="team-img rounded-circle">
                                    <img src="./admin/images/<?php echo $customer_data['profile']; ?>"
                                        class="img-fluid w-100 rounded-circle" alt="">
                                </div>
                                <div class="team-name text-center py-3">
                                    <h4 class=""><?php echo $customer_data['pro_name']; ?></h4>
                                    <p class="m-0"><?php echo $customer_data['description']; ?></p>
                                </div>
    ...
    <div class="container-fluid testimonial py-5 mb-5">
        <div class="container">
            <?php
            $customer_sql = mysqli_query($conn, "SELECT * FROM testimonial");
            $customer_data = mysqli_fetch_array($customer_sql);
            ?>
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                <h5 class="text-primary"><?php echo $customer_data['title']; ?></h5>
                ...
                while ($customer_data = mysqli_fetch_array($customer_sql)) {
                    ...
                    <div class="testimonial-item border p-4">
                        ...
                        <div class="border-top mt-4 pt-3">
                            <p class="mb-0"><?php echo $customer_data['description']; ?></p>
                        </div>
                    </div>
                    <!-- <div class="testimonial-item border p-4">
                        <div class=" d-flex align-items-center">
                        ...
                        <div class="border-top mt-4 pt-3">
                            <p class="mb-0">Lorem ipsum dolor sit amet elit. Sed efficitur quis purus ut
                                interdum
                                aliquam
                                dolor eget urna. Nam volutpat libero sit amet leo cursus, ac viverra eros morbi
                                quis
                                quam
                                mi.</p>
                        </div>
    ...
    <div class="container-fluid py-5 mb-5">
        <div class="container">
            <?php
            $customer_sql = mysqli_query($conn, "SELECT * FROM contact");
            $customer_data = mysqli_fetch_array($customer_sql);
            ?>
            <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                <h5 class="text-primary"><?php echo $customer_data['title']; ?></h5>
                <h1 class="mb-3"> <?php echo $customer_data['heading']; ?></h1>
                <p class="mb-2"><?php echo $customer_data['description']; ?> <a
        ...
        <div class="container pt-5 pb-4">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <a href="index.html">
                        <h1 class="text-white fw-bold d-block">High<span class="text-secondary">Tech</span>
                        </h1>
                    </a>
                    <p class="mt-4 text-light">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Soluta
                        facere
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="mt-4 d-flex flex-column help-link">
                        ...
                        <a href="" class="mb-2 text-white"><i
                                class="fas fa-angle-right text-secondary me-2"></i>Help</a>
                        <a href="" class="mb-2 text-white"><i
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="text-white mt-4 d-flex flex-column contact-link">
                        <a href="#" class="pb-3 text-light border-bottom border-primary"><i
                                class="fas fa-map-marker-alt text-secondary me-2"></i> 123 Street, New York,
                            USA</a>
            ...
            <div class="row">
                <div class="col-md-6 text-center text-md-start">
                    <span class="text-light"><a href="#" class="text-secondary"><i
                                class="fas fa-copyright text-secondary me-2"></i>Your Site Name</a>, All
                        right
                        reserved.</span>
                </div>
