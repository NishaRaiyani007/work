    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <table>
                ...
                $slider_sql = mysqli_query($conn, "SELECT * FROM slider where id='$id'");
                ...
                <form action="slider_action.php" method="post" enctype="multipart/form-data">
                    <div class="base_formbil">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="upload/sub_category/<?php echo $row['image']; ?>" width="50px" />
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="simpleinput" name="contect" value="<?php echo $row['contect'] ?>"
                                class="form-control border border-secondary">
                        </div>
                        <?php if ($id != null) {
                            ?>
            ...
            <table>
                ...
                $list_sql = mysqli_query($conn, "SELECT * FROM slider");
                ...
                while ($list_show = mysqli_fetch_array($list_sql)) {
                    ...
                    <tr>
                        ...
                        <td> <img src="./images/<?php echo $list_show['image']; ?>" width="100"></td>
                        <td><?php echo $list_show['heading']; ?></td>
                        <td><?php echo $list_show['description']; ?></td>
                        <td><?php echo $list_show['contect']; ?></td>
                        <td> <a href="slider.php?id=<?php echo $list_show['id']; ?>" class="btn btn-info btn-sm">Edit</a>
                        </td>
                        <td> <a href="slider_action.php?id=<?php echo $list_show['id']; ?>"
