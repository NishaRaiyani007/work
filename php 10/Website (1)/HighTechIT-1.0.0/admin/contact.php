    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <table>
                ...
                $slider_sql = mysqli_query($conn, "SELECT * FROM contact where id='$id'");
                ...
                <form action="contact_action.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-5 col-5 mx-auto">
                        <div class="base_formbil">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="simpleinput" name="heading"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" id="example-fileinput" name="icon"
                                    value="<?php echo $row['icon']; ?>" class="form-control" />
                                <img src="upload/sub_category/width=" 50px>
                            </div>
                            <div class="mb-3">
                                <label for="example-fileinput" class="form-label">icon_link</label>
                                <input type="text" id="example-fileinput" name="icon_link"
                                    value="<?php echo $row['icon_link']; ?>" class="form-control" />
                            </div>
                            <div class="mb-3">
                                <label for="example-fileinput" class="form-label">map</label>
                                <input type="url" id="example-fileinput" name="map" value="<?php echo $row['map']; ?>"
                                    class="form-control" />
                            </div>
            ...
            <table>
                ...
                $list_sql = mysqli_query($conn, "SELECT * FROM contact");
                ...
                while ($list_show = mysqli_fetch_array($list_sql)) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $list_show['icon']; ?></td>
                        <td><?php echo $list_show['icon_link']; ?></td>
                        <td><?php echo $list_show['map']; ?></td>
                        <td> <a href="contact.php?id=<?php echo $list_show['id']; ?>" class="btn btn-info btn-sm">Edit</a>
                        </td>
                        <td> <a href="contact_action.php?id=<?php echo $list_show['id']; ?>"
