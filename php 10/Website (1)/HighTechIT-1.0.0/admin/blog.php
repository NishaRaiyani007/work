    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <table>
                ...
                $slider_sql = mysqli_query($conn, "SELECT * FROM blog where id='$id'");
                    ...
                    <div class="col-md-5 col-5 mx-auto">
                        <div class="base_formbil">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" id="example-fileinput" name="image" value="<?php echo $row['img'] ?>"
                                    class="form-control">
                                <img src="upload/sub_category/width=" 50px>
                            </div>
                            <!-- <div class="mb-3">
                                <label for="example-fileinput" class="form-label">profile</label>
                                <input type="file" id="example-fileinput" name="profile"
                                    value="<?php echo $row['profile'] ?>" class="form-control">
                                <img src="upload/sub_category/width=" 50px>
                            </div> -->
                            <div class="mb-3">
                                <label for="example-fileinput" class="form-label">pro_date</label>
                                <input type="date" id="example-fileinput" name="pro_date"
                                    value="<?php echo $row['pro_date'] ?>" class="form-control">
                                <img src="upload/sub_category/width=" 50px>
                            </div>
                            <div class="mb-3">
            ...
            <table>
                ...
                <?php
                $list_sql = mysqli_query($conn, "SELECT * FROM blog");
                ...
                while ($list_show = mysqli_fetch_array($list_sql)) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $list_show['img']; ?></td>
                        <td><?php echo $list_show['profile']; ?></td>
                        <td><?php echo $list_show['pro_date']; ?></td>
                        <td><?php echo $list_show['description']; ?></td>
                        <td> <a href="blog.php?id=<?php echo $list_show['id']; ?>" class="btn btn-info btn-sm">Edit</a>
                        </td>
                        <td> <a href="blog_action.php?id=<?php echo $list_show['id']; ?>"
