    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <table>
                ...
                $slider_sql = mysqli_query($conn, "SELECT * FROM admin where id='$id'");
                    ...
                    <div class="col-md-10 col-10 mx-auto">
                        <div class="base_formbil">
                            <div class="mb-3">
                                ...
                                <input type="text" id="simpleinput" name="name" value="<?php echo $row['name']; ?>"
                                    class="form-control border border-secondary">
                            </div>
                            <div class="mb-3">
                                <label for="simpleinput" class="form-label">email</label>
                                <input type="text" id="simpleinput" name="email" value="<?php echo $row['email']; ?>"
                                    class="form-control border border-secondary">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="simpleinput" class="form-label">contect</label>
                                <input type="phone" id="simpleinput" name="contect"
                                    value="<?php echo $row['contect']; ?>" class="form-control border border-secondary">
                            </div>
                            <div class="mb-3">
                                <label for="simpleinput" class="form-label">icon_fb</label>
                                <input type="file" id="simpleinput" name="image"
                                    value="<?php echo $row['icon_fb']; ?>" class="form-control border border-secondary">
                            </div>
                            <div class="mb-3">
                                <label for="simpleinput" class="form-label">icon_twitter</label>
                                <input type="file" id="simpleinput" name="image"
                                    value="<?php echo $row['icon_twitter']; ?>"
                                    class="form-control border border-secondary">
                            </div>
                            <div class="mb-3">
                                <label for="simpleinput" class="form-label">icon_insta</label>
                                <input type="file" id="simpleinput" name="image"
                                    value="<?php echo $row['icon_insta']; ?>"
                                    class="form-control border border-secondary">
                            </div>
                            <div class="mb-3">
            ...
            <table>
                ...
                $list_sql = mysqli_query($conn, "SELECT * FROM admin");

                while ($list_show = mysqli_fetch_array($list_sql)) {

                    ?>
                    <tr>
                        <td><?php echo $list_show['name']; ?></td>   
                        <td><?php echo $list_show['email']; ?></td>  
                        <td><?php echo $list_show['password']; ?></td>
                        <td><?php echo $list_show['contect']; ?></td>
                        <td><?php echo $list_show['icon_fb']; ?></td>
                        <td><?php echo $list_show['icon_twitter']; ?></td>
                        <td><?php echo $list_show['icon_insta']; ?></td>
                        <td><?php echo $list_show['icon_in']; ?></td> 
                        <td><?php echo $list_show['tital']; ?></td>
                        <td><?php echo $list_show['description']; ?></td>
                        <td> <a href="admin.php?id=<?php echo $list_show['id']; ?>" class="btn btn-info btn-sm">Edit</a>
                        </td>
                        <td> <a href="admin_action.php?id=<?php echo $list_show['id']; ?>"
