    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <table>
                ...
                $slider_sql = mysqli_query($conn, "SELECT * FROM counter where id='$id'");

                $row = mysqli_fetch_array($slider_sql);

                ?>
                <form action="counter_action.php" method="post" enctype="multipart/form-data">
            ...
            <table>
                ...
                $list_sql = mysqli_query($conn, "SELECT * FROM counter");
                ...
                while ($list_show = mysqli_fetch_array($list_sql)) {
                    ...
                    <tr>
                        ...
                        <td> <a href="counter.php?id=<?php echo $list_show['id']; ?>" class="btn btn-info btn-sm">Edit</a>
                        </td>
                        <td> <a href="counter_action.php?id=<?php echo $list_show['id']; ?>"
