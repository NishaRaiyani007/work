    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <table>
                ...
                $slider_sql = mysqli_query($conn, "SELECT * FROM project where id='$id'");
            ...
            <table>
                ...
                $list_sql = mysqli_query($conn, "SELECT * FROM project");
                ...
                while ($list_show = mysqli_fetch_array($list_sql)) {
                    ...
                    <tr>
                        ...
                        <td><img src="./images/<?php echo $list_show['img']; ?>" width="100"></td>
                        <td> <a href="project.php?id=<?php echo $list_show['id']; ?>" class="btn btn-info btn-sm">Edit</a>
                        </td>
                        <td> <a href="project_action.php?id=<?php echo $list_show['id']; ?>"
