    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <table>
                ...
                $slider_sql = mysqli_query($conn, "SELECT * FROM testimonial where id='$id'");

                $row = mysqli_fetch_array($slider_sql);

                ?>

                <form action="testimonial_action.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-10 col-10 mx-auto">
                        <div class="base_formbil">
                            ...
                            <input type="text" id="simpleinput" name="description"
                                value="<?php echo $row['description'] ?>" class="form-control border border-secondary">
            ...
            <table>
                ...
                $list_sql = mysqli_query($conn, "SELECT * FROM testimonial");
                ...
                while ($list_show = mysqli_fetch_array($list_sql)) {
                    ...
                    <tr>
                        ...
                        <td> <a href="testimonial.php?id=<?php echo $list_show['id']; ?>"
                                class="btn btn-info btn-sm">Edit</a></td>
                        <td> <a href="testimonial_action.php?id=<?php echo $list_show['id']; ?>"
