<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Employee.master" AutoEventWireup="true" CodeFile="EmployeeUploadResume.aspx.cs" Inherits="UploadResume" %>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td class="auto-style1">
                     <asp:Label ID="Label17" runat="server" Text="Fill Resume Profile" Font-Bold="True"  Font-Italic="True" ForeColor="Blue" Font-Names="Lucida Calligraphy" Font-Size="Large"></asp:Label>
                </td>
            <tr>
                <td class="auto-style3">
                     &nbsp;</td>
