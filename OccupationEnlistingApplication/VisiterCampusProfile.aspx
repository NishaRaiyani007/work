<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Visiter.master" AutoEventWireup="true" CodeFile="VisiterCampusProfile.aspx.cs" Inherits="VisiterCampusProfile" %>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td class="auto-style1">
                     <asp:Label ID="Label17" runat="server" Text="Campus Profile" Font-Bold="True"  Font-Italic="True" ForeColor="Blue" Font-Names="Lucida Calligraphy" Font-Size="Large"></asp:Label>
                </td>
            <tr>
                <td class="auto-style3">
                     &nbsp;</td>
