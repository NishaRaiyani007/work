<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Visiter.master" AutoEventWireup="true" CodeFile="HomePage-Visiter.aspx.cs" Inherits="VisitorHomePage" %>
				...
				<div id="sequence">
					...
					<ul>
						...
						<li>
							...
							<img class="slider_img" src="images/home2.jpg"/>
						</li>
						...
						<li>
                            ...
                            <img class="slider_bgr animate-in" src="images/1.jpg"/>
							<img class="slider_img" src="images/M_Id_420133_Jobs.jpg" width="701" height="400"  alt=""/>
						</li>					
					</ul>
				</div>
			</div>
				...
				<div class="section_featured_services">
					...
					<ul id="featured_services_carousel">
						<li class="four columns">
							<div class="pic">
								<a href=""><img src="images/th1.jpg"/></a>
							</div>
