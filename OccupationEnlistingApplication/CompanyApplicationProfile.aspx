<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Company.master" AutoEventWireup="true" CodeFile="CompanyApplicationProfile.aspx.cs" Inherits="Application_Details" %>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td class="auto-style4">
                     <asp:Label ID="Label1" runat="server" Text="Appliication Profile" Font-Bold="True"  Font-Italic="True" ForeColor="Blue" Font-Names="Lucida Calligraphy" Font-Size="Large"></asp:Label>
                </td>
