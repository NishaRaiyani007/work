<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Company.master" AutoEventWireup="true" CodeFile="CompanyFeedback.aspx.cs" Inherits="GiveFeedback" %>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td class="auto-style3">
                     <asp:Label ID="Label17" runat="server" Text="Feedback
...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataKeyNames="Id" Height="153px" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" PageSize="4">
            <Columns>
