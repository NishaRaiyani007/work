<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Company.master" AutoEventWireup="true" CodeFile="CompanyEducationProfile.aspx.cs" Inherits="Education_Details" %>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td class="auto-style1">
                     <asp:Label ID="Label17" runat="server" Text="Education Profile" Font-Bold="True"  Font-Italic="True" ForeColor="Blue" Font-Names="Lucida Calligraphy" Font-Size="Large"></asp:Label>
                </td>
            <tr>
                <td class="auto-style2">
                     &nbsp;</td>
