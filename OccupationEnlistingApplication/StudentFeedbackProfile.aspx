<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Student.master" AutoEventWireup="true" CodeFile="StudentFeedbackProfile.aspx.cs" Inherits="Give_Feedback" %>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td class="auto-style3">
                     <asp:Label ID="Label17" runat="server" Text="Feedback" Font-Bold="True"  Font-Italic="True" ForeColor="Blue" Font-Names="Lucida Calligraphy" Font-Size="Large"></asp:Label>
                </td>
            <tr>
                <td class="auto-style2">
                     &nbsp;</td>
             ...
             <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtTitle" runat="server" style="margin-top: 0px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataKeyNames="Id" Height="153px" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" PageSize="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
             <Columns>
                ...
                <asp:BoundField DataField="Title" HeaderText="User Title" SortExpression="Title" />
