<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Employee.master" AutoEventWireup="true" CodeFile="EmployeeProfessionalDetail.aspx.cs" Inherits="Proffetional_Detail" %>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td class="auto-style2">
                     <asp:Label ID="Label1" runat="server" Text="Professional 
                         Details" Font-Bold="True"  Font-Italic="True" ForeColor="Blue" Font-Names="Lucida Calligraphy" Font-Size="Large"></asp:Label>
                </td>
                <td>
                    &nbsp;</td>
                <td>&nbsp;</td>
