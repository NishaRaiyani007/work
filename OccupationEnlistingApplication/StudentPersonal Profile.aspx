<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Student.master" AutoEventWireup="true" CodeFile="StudentPersonal Profile.aspx.cs" Inherits="Personal_Profile" %>
        ...
        <table style="width:100%;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <%--<asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Your Age Is In Between 18 to 25" ControlToValidate="TxtRange" Display="Dynamic" MaximumValue="25" MinimumValue="18" SetFocusOnError="True"></asp:RangeValidator>--%>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
