<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Employee.master" AutoEventWireup="true" CodeFile="EmployeeJobDiscription.aspx.cs" Inherits="Job_Destinaton" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataKeyNames="Id" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" PageSize="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
            <Columns>
                ...
                <asp:TemplateField HeaderText="User Timing" SortExpression="Timing">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User Reference" SortExpression="Reference">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User Job_Status" SortExpression="Job_Status">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User Job_Name" SortExpression="Job_Name">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User Job_StartDate" SortExpression="Job_StartDate">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User ApplicationName" SortExpression="ApplicationName">
                    <EditItemTemplate>
