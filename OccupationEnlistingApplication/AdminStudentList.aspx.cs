...
public partial class AdminStudentList : System.Web.UI.Page
{
    ...
    private void BindPersonal()
    {
        ...
        GridView1.DataSource = dcobj2.BindPersonal(Session["User_Id"].ToString()).Tables[1];
        GridView1.DataBind();
    }
    ...
    {
        Dataclass dcobj2 = new Dataclass();
        //DetailsView4.DataSource = dcobj2.StudentDetails1Data(GridView1.SelectedValue.ToString());
        //DetailsView4.DataBind();
        DetailsView1.DataSource = dcobj2.StudentDetails1Data(GridView1.SelectedValue.ToString());
        DetailsView1.DataBind();
        DetailsView3.DataSource = dcobj2.EducationDetails1Data(GridView1.SelectedValue.ToString());
