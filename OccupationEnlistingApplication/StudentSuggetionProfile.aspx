<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Student.master" AutoEventWireup="true" CodeFile="StudentSuggetionProfile.aspx.cs" Inherits="Put_Suggetion" %>
    ...
    <div>
        ...
        <table style="width:100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TxtTitle" runat="server" Height="16px" Width="122px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
