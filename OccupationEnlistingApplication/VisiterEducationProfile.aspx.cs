...
public partial class EducationDetail : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        dcobj1.InsertEdu(TxtSchoolName.Text, TxtSSCPercentage.Text, TxtHSCPercentage.Text, DDESelectValue.SelectedValue.ToString(), TxtCollegeNameUG.Text, TxtUniversityNamePG.Text, TxtDegreeUG.Text, TxtCPIUG.Text, TxtPassingYearUG.Text, TxtCollegeNamePG.Text, TxtUniversityNamePG.Text, DDSelectValue.SelectedValue.ToString(), TxtCPIPG.Text, DDSelectValue1.SelectedValue.ToString(), TxtExtraCurricular.Text, Session["User_Id"].ToString());
    }
