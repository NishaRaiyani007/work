...
public partial class AvailableCampus : System.Web.UI.Page
{
    ...
    private void BindCampus()
    {
        ...
        GridView1.DataSource = dcobj12.BindCampus(Session["User_Id"].ToString()).Tables[0];
        GridView1.DataBind();
