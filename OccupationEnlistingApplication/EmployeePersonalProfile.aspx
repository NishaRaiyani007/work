<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage-Employee.master" AutoEventWireup="true" CodeFile="EmployeePersonalProfile.aspx.cs" Inherits="PersonalProfile" %>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td class="auto-style1">
                     <asp:Label ID="Label17" runat="server" Text="Personal Profile" Font-Bold="True"  Font-Italic="True" ForeColor="Blue" Font-Names="Lucida Calligraphy" Font-Size="Large"></asp:Label>
                </td>
             <tr>
                <td class="auto-style2">
                     &nbsp;</td>
             ...
             <tr>
                ...
                <td>
                    ...
                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Your Name" ControlToValidate="TxtFirstName"></asp:RequiredFieldValidator>--%>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Your Age Is In Between 18 to 25" ControlToValidate="TxtAge" Display="Dynamic" MaximumValue="25" MinimumValue="18" SetFocusOnError="True"></asp:RangeValidator>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" DataKeyNames="Id" PageSize="4" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
            <Columns>
                <asp:TemplateField HeaderText=" user FirstName" SortExpression="FirstName">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User MiddleName" SortExpression="MiddleName">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User LastName" SortExpression="LastName">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User Age" SortExpression="Age">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User Gender" SortExpression="Gender">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User DateOfBirth" SortExpression="DateOfBirth">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User Address1" SortExpression="Address1">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="UserAddress2" SortExpression="Address2">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User City" SortExpression="City">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User State" SortExpression="State">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User Country" SortExpression="Country">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User Nationality" SortExpression="Nationality">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User Hobby" SortExpression="Hobby">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User ContactNo" SortExpression="ContactNo">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User MobileNo" SortExpression="MobileNo">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="User EmailId" SortExpression="EmailId">
                    <EditItemTemplate>
