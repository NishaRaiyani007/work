<%@ Reference Control="~/CCPager.ascx" %>
...
<tr id=Recommended_no_records runat="server"><td style="background-color: #FFFFFF; border-width: 1" colspan="4"><font style="font-size: 10pt; color: #000000">No records</font></td></tr>
	<tr><td><asp:Repeater id=Recommended_Repeater 
            onitemdatabound="Recommended_Repeater_ItemDataBound" runat="server" 
            onitemcommand="Recommended_Repeater_ItemCommand">
	<HeaderTemplate>
	</td></tr>
	</HeaderTemplate>
	<ItemTemplate>
