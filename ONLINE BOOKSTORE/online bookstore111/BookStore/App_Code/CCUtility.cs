...
//  GlobalFuncs Event end
	...
	public void DBOpen()
	{
		...
		Connection = new OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|BookStore_MSAccess.mdb");
        Connection.Open();
      ...
      //  {
       //     connection="Provider=Microsoft.Jet.OLEDB.4.0;Data Source=F:\ashvin\BookStore\BookStore_MSAccess.mdb";
       // }
