<%@ Page Language="C#" MasterPageFile="~/mymaster.master" AutoEventWireup="true" CodeFile="entertainment.aspx.cs" Inherits="entertainment" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <center>
        <asp:Label ID="Label1" runat="server" BackColor="#FFC080" Font-Size="X-Large" ForeColor="#400040"
            Height="31px" Text="Entertainment Books" Width="233px"></asp:Label><br />
        <br />
        <asp:HyperLink ID="progcatlink" runat="server" Font-Bold="True" Font-Names="Calibri"
            Font-Size="Large" ForeColor="#404000" NavigateUrl="~/movie.aspx">1.Movies</asp:HyperLink><br />
        <br />
        <asp:HyperLink ID="dbcatlink" runat="server" Font-Bold="True" Font-Names="Calibri"
            Font-Size="Large" ForeColor="#404000" NavigateUrl="~/music.aspx">2.Music</asp:HyperLink><br />
        <br />
        <asp:HyperLink ID="htmlcatlink" runat="server" Font-Bold="True" Font-Names="Calibri"
            Font-Size="Large" ForeColor="#404000" NavigateUrl="~/puzzle.aspx">4.Puzzles & Games</asp:HyperLink><br />
        <br />
        &nbsp;</center>
    <br />
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
